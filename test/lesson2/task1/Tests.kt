...
class Tests {
    ...
    fun ageDescription() {
        ...
        assertEquals("52 года", ageDescription(52))
    }
    ...
    fun timeForHalfWay() {
        ...
        assertEquals(5.0, timeForHalfWay(5.0, 2.0, 5.0, 1.0, 5.0, 1.0), 1e-2)
        assertEquals(10.833, timeForHalfWay(5.0, 1.0, 5.0, 1.0, 5.0, 3.0), 1e-2)
    }
