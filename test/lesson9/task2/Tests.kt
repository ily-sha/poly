    ...
    fun generateSpiral() {
        ...
        assertEquals(createMatrix(
            ...
            listOf(
                ...
                listOf(28,29,30,31,32,33,34,9),
                listOf(27,48,49,50,51,52,35,10),
                listOf(26,47,60,61,62,53,36,11),
                listOf(25,46,59,64,63,54,37,12),
                listOf(24,45,58,57,56,55,38,13),
                listOf(23,44,43,42,41,40,39,14),
                listOf(22,21,20,19,18,17,16,15))
        ), generateSpiral(3, 4))
    }
