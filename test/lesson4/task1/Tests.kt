...
class Tests {
    ...
    @Tag("Example")
    fun isPalindrome() {
        assertFalse(isPalindrome("Ѕарабан"))
        assertTrue(isPalindrome("ј роза упала на лапу јзора"))
        assertTrue(isPalindrome("Ўалаш"))
    }
    ...
    @Tag("7")
    fun russian() {
        assertEquals("триста семьдес€т п€ть", russian(375))
        assertEquals("двадцать две тыс€чи дев€тьсот шестьдес€т четыре", russian(22964))
        assertEquals("сто дев€тнадцать тыс€ч п€тьсот восемь", russian(119508))
        assertEquals("две тыс€чи три", russian(2003))
        assertEquals("двести тыс€ч два", russian(200002))
        assertEquals("дев€тьсот тыс€ч", russian(900000))
